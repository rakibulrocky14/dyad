...
export const MODEL_OPTIONS: Record<string, ModelOption[]> = {
  ...
  google: [
    ...
    // https://ai.google.dev/gemini-api/docs/models#gemini-2.5-flash-lite
    {
      ...
      description: "Lightest and cheapest Gemini 2.5 model for fast tasks",
      maxOutputTokens: 65_536 - 1,
      contextWindow: 1_048_576,
      temperature: 0,
    },
  ...
  vertexai: [
    // https://cloud.google.com/vertex-ai/generative-ai/docs/learn/model-versioning
    {
      name: "gemini-2.5-pro",
      displayName: "Gemini 2.5 Pro",
      description: "Gemini 2.5 Pro on Vertex AI",
      maxOutputTokens: 65_536 - 1,
      contextWindow: 1_048_576,
      temperature: 0,
    },
    {
      name: "gemini-2.5-flash",
      displayName: "Gemini 2.5 Flash",
      description: "Gemini 2.5 Flash on Vertex AI",
      maxOutputTokens: 65_536 - 1,
      contextWindow: 1_048_576,
      temperature: 0,
    },
    {
      name: "gemini-2.5-flash-lite",
      displayName: "Gemini 2.5 Flash Lite",
      description: "Gemini 2.5 Flash Lite on Vertex AI",
      maxOutputTokens: 65_536 - 1,
      contextWindow: 1_048_576,
      temperature: 0,
    },
